  ...
  return (
    <main className={`page-shell project-page${light ? ' light' : ''}`}>
      ...
      <article id="case-study" aria-live="polite">
        ...
        <div className="case-visual" style={{ backgroundImage: `url('/assets/${slug}.jpg')` }}><div className="visual-card"><small>PROJECT / {project.tags[0].toUpperCase()}</small><h3>{project.title}</h3><p>A prototype for clearer, more human digital work.</p><div className="bar" /><div className="bar short" /></div></div>
